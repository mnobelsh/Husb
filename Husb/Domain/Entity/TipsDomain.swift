...
extension TipsDomain {
    ...
    static let tipsList: [TipsDomain] = [
            .init(title: "GINGER VS. NAUSEA", description: "consuming ginger may be an effective way to reduce nausea during pregnancy. Most experts consider ginger to be a safe, effective remedy during pregnancy"),
